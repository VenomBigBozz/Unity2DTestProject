...
{
    [SerializeField] private float m_PlayerHealth = 5f;                         // How much health the player have
    ...
    private void FixedUpdate()
    {
        ...
        if (m_Grounded && timeInAir < 5 && timeInAir > 0)
            timeInAir = 5;

        //Making the player die when it reaches 0
        if (timeInAir <= 0 || m_PlayerHealth == 0)
        {
            m_PlayerHealth = 0;
            Debug.Log("You Died!");
        }
